...
export default function Sidebar({ isOpen, onClose, selectedLanguage, onLanguageSelect }) {
  ...
  const getFileIcon = (ext, fileName) => {
    ...
    if (e === '.java') return <img src={languageLogos.java} alt="" className="tree-logo-icon" />;
    if (e === '.rs') return <img src={languageLogos.rust} alt="" className="tree-logo-icon" />;
    if (e === '.cpp' || e === '.c++') return <img src={languageLogos.cpp} alt="" className="tree-logo-icon" />;
    if (e === '.c') return <img src={languageLogos.c} alt="" className="tree-logo-icon" />;
